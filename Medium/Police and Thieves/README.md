<h2><a href="https://practice.geeksforgeeks.org/problems/police-and-thieves--141631/1?page=2&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=submissions">Police and Thieves</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of size <strong>n</strong> such that each element contains either a 'P' for policeman or a 'T' for thief. Find the maximum number of thieves that can be caught by the police.&nbsp;<br>
