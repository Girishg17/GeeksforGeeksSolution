<h2><a href="https://www.geeksforgeeks.org/problems/merge-k-sorted-arrays/1?page=3&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Merge k Sorted Arrays</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given <strong>K</strong> sorted arrays arranged in the form of a matrix of size K*K. The task is to merge them into one sorted array.<br>
