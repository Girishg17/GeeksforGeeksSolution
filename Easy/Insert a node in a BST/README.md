<h2><a href="https://practice.geeksforgeeks.org/problems/insert-a-node-in-a-bst/1?page=2&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=submissions">Insert a node in a BST</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>BST</strong> and a key <strong>K</strong>. If K is not present in the BST, Insert a new Node with a value equal to K into the BST. If K is already present in the BST, don't modify the BST.</span></p>
